...
const cards = [
  {
    ...
    description: "Set up your agrowFarm account and start managing your farm.",
    icon: () => {
      ...
      return (
        <>
          <p>
            ...
            may or may not be relevant to the actual features of agrowFarm.
          </p>
          <p>
            Welcome to agrowFarm! Follow these steps to set up your account and
          ...
          <ol className="list-decimal space-y-4 pl-8">
            ...
            <li>
              <strong>Use Smart Tools:</strong> Leverage agrowFarm's smart tools
          ...
          <p>
            ...
            managing your farm with agrowFarm. Our comprehensive tools and
          ...
          <p>
            ...
            about making informed decisions. Leverage agrowFarm to enhance your
            productivity and achieve better yields.
          </p>
          <p>
            Thank you for choosing agrowFarm. We are excited to be a part of
  ...
  {
    title: "Using agrowFarm",
    description:
      "Guidelines and best practices to make the most out of agrowFarm.",
    icon: () => {
      ...
      return (
        <>
          ...
          <p>
            ...
            agrowFarm. Follow these guidelines and best practices to maximize
            your efficiency.
          </p>
          <ol className="list-decimal space-y-4 pl-8">
            <li>
              <strong>Dashboard Overview:</strong> Familiarize yourself with the
              agrowFarm dashboard. It provides a comprehensive view of your
            ...
            <li>
              <strong>Pest and Disease Alerts:</strong> agrowFarm provides
            ...
            <li>
              <strong>Community Forums:</strong> Join the agrowFarm community
            ...
            <li>
              <strong>Mobile Access:</strong> Access agrowFarm on the go with
            ...
            <li>
              ...
              agrowFarm support team is here to help. Access the help center for
              FAQs, guides, and contact information.
            </li>
          </ol>
          <p>
            By following these best practices, you'll harness the full potential
            of agrowFarm to improve your farm's productivity and efficiency.
      ...
      return (
        <>
          ...
          <p>
            ...
            your teams and billing in agrowFarm.
          </p>
          <ol className="list-decimal space-y-4 pl-8">
            <li>
              <strong>Add Team Members:</strong> Invite your team members to
              join your agrowFarm workspace. Provide them with appropriate roles
            ...
            <li>
              ...
              activities of your team members within agrowFarm. Regularly review
            ...
            <li>
              ...
              any discrepancies to the agrowFarm support team immediately.
            </li>
            <li>
              ...
              budget. Use agrowFarm's budgeting tools to track and manage your
            ...
            <li>
              ...
              match your branding and send them directly from agrowFarm.
            </li>
            <li>
              <strong>Access Support:</strong> If you have any questions or
              issues related to billing or team management, reach out to
              agrowFarm's support team for assistance. They are available to
          ...
          <p>
            ...
            tools and features provided by agrowFarm to stay organized and
            efficient.
          </p>
        </>
      );
    ...
    content: () => {
      return (
        <>
          ...
          <p>
            Integrating agrowFarm with other tools and platforms can enhance
            your farming operations by consolidating data and streamlining
            workflows. Here's how to manage integrations effectively.
          </p>
          <ol className="list-decimal space-y-4 pl-8">
            <li>
              <strong>Connect to Third-Party Tools:</strong> Link agrowFarm with
            ...
            <li>
              <strong>API Access:</strong> Utilize the agrowFarm API to create
            ...
            <li>
              ...
              other systems into agrowFarm and export your farm data for use in
            ...
            <li>
              ...
              between agrowFarm and other tools to save time and reduce manual
            ...
            <li>
              ...
              up-to-date with the latest versions of agrowFarm and third-party
            ...
            <li>
              ...
              agrowFarm support for any assistance needed in setting up or
              troubleshooting integrations.
            </li>
            <li>
              <strong>Feedback and Improvements:</strong> Share your feedback on
              integration experiences with the agrowFarm team. Suggest
          ...
          <p>
            ...
            seamlessly. Utilize agrowFarm's integration features to maximize
    ...
    content: () => {
      return (
        <>
          ...
          <p>
            Encountering issues while using agrowFarm? Follow these
          ...
          <ol className="list-decimal space-y-4 pl-8">
            ...
            <li>
              ...
              latest version of your web browser. agrowFarm is optimized for
            ...
            <li>
              ...
              agrowFarm app and any integrated tools are updated to the latest
            ...
            <li>
              <strong>Consult the Help Center:</strong> Visit the agrowFarm Help
            ...
            <li>
              ...
              on your own, reach out to agrowFarm customer support. Provide
            ...
            <li>
              ...
              device meets the system requirements for running agrowFarm.
            ...
            <li>
              ...
              persistent issues, try reinstalling the agrowFarm application.
              This can resolve corrupted files or installation problems.
            </li>
            <li>
              <strong>Report Bugs:</strong> If you encounter a bug, report it to
              the agrowFarm team. Your feedback helps improve the platform and
              ensures that issues are addressed in future updates.
            </li>
          </ol>
          <p>
            By following these troubleshooting steps, you can resolve most
            common issues and maintain the smooth operation of agrowFarm. If you
            need further assistance, the agrowFarm support team is always ready
            to help.
          </p>
        </>
      );
