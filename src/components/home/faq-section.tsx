...
const questions = [
  {
    question: "What is agrowFarm?",
    answer:
      "agrowFarm is an AI-powered platform providing personalized agricultural advice, real-time assistance, and resources to support farmers.",
    highlight: [],
  },
  {
    question: "How do I get started with agrowFarm?",
    answer:
      "Sign up on our homepage and follow the prompts to input your crop details for personalized advice.",
    highlight: [],
  },
  {
    question: "Is agrowFarm free to use?",
    answer:
      "Yes, agrowFarm offers a free basic plan with essential features. There are also premium plans available with advanced features and additional support.",
    highlight: [],
  },
  {
  ...
  {
    question: "Can I integrate agrowFarm with other tools?",
    answer:
      "Yes, agrowFarm can be integrated with various farming tools and platforms. Visit the Integrations section for detailed instructions.",
    highlight: [],
  },
  {
    question: "How do I manage my team on agrowFarm?",
    answer:
