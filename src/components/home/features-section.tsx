...
const items = [
  ...
  },
  {
    ...
    description: <span className="text-sm min-h-[2.5rem] line-clamp-2 text-muted-foreground">Receive assistance and resources in various Nepali languages for better accessibility and understanding.</span>,
